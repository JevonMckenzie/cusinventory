class MaintenancesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @maintenance.save
        MaintenanceMailer.maintenance_email(@maintenance).deliver
        format.html { redirect_to @maintenance, notice: 'Post Modification Request has been submitted.' }
  ...
  private
    ...
    def maintenance_params
      params.require(:maintenance).permit(:nointernet, :compnopower, :compshutdown, :novideo, :keyboard, :mouse, :printerjam, :printernowork, :scanner, :other, :explanation, :location, :office, :asycuda, :slonfreeze, :othersoftware, :explanationsoft, :locationsoft, :hardware, :software)
    end
end
